package com.example.pertemuan12_71190479
...
class MainActivity : AppCompatActivity() {
    ...
    fun cekCuaca(kota: String){
        val url = "https://api.openweathermap.org/data/2.5/forecast?q=${kota}&appid=7863ba7fb08aa1c1774d51a3e2da71e5&units=metric"
